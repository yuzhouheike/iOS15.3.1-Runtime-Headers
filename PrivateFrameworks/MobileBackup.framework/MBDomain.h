...
- (int)_cachedFileDescriptorWithSnapshotPath:(id)arg1 volumeMountPoint:(id)arg2 error:(id*)arg3;
- (bool)_loadDomainFromExternalPlist:(id)arg1;
- (bool)_loadSystemDomain:(id)arg1 plist:(id)arg2 accountType:(long long)arg3 volumeMountPoint:(id)arg4;
- (int)cachedFileDescriptorWithSnapshotPath:(id)arg1 volumeMountPoint:(id)arg2 error:(id*)arg3;
...
- (id)initWithName:(id)arg1 plist:(id)arg2 accountType:(long long)arg3 volumeMountPoint:(id)arg4;
