...
@interface MNNavigationSession : NSObject <GEOMotionContextDelegate, MNAudioManagerObserver, MNGuidanceManagerDelegate, MNLocationManagerHeadingObserver, MNLocationManagerObserver, MNLocationTrackerDelegate, MNSessionUpdateManagerDelegate, MNTimeAndDistanceUpdaterDelegate, MNTracePlayerObserver, MNVehicleMonitorDelegate> {
...
@property (nonatomic, retain) <MNAudioProvider> *audioProvider;
...
- (void)forceReroute;
- (void)guidanceManager:(id)arg1 announce:(id)arg2 isImportant:(bool)arg3 shortPromptType:(unsigned long long)arg4 ignorePromptStyle:(bool)arg5 stage:(unsigned long long)arg6 hasSecondaryManeuver:(bool)arg7 completionBlock:(id /* block */)arg8;
