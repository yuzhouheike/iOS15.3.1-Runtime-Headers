...
@interface UISUIActivityViewControllerConfiguration : NSObject <NSSecureCoding> {
    ...
    bool  _wantsPeopleSuggestionsData;
...
@property (nonatomic) bool wantsPeopleSuggestionsData;
...
- (void)setWantsPeopleSuggestionsData:(bool)arg1;
...
- (id)urlsBeingShared;
- (bool)wantsPeopleSuggestionsData;
