...
+ (struct Ref<WebCore::Frame, WTF::RawPtrTraits<WebCore::Frame>> { struct Frame {} *x1; })_createFrameWithPage:(void*)arg1 frameName:(const void*)arg2 frameView:(id)arg3 ownerElement:(void*)arg4;
...
+ (struct Ref<WebCore::Frame, WTF::RawPtrTraits<WebCore::Frame>> { struct Frame {} *x1; })_createSubframeWithOwnerElement:(void*)arg1 frameName:(const void*)arg2 frameView:(id)arg3;
