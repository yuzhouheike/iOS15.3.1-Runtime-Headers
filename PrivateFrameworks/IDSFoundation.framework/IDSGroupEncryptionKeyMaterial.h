...
- (id)initWithKeyMaterial:(id)arg1 keySalt:(id)arg2 keyIndex:(id)arg3 groupID:(id)arg4 isGeneratedLocally:(bool)arg5 createdAt:(id)arg6 generationCounter:(unsigned int)arg7;
