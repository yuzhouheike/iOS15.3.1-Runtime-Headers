...
- (void)_notifySessionStreamInfoReceived:(id)arg1 withParticipants:(id)arg2 lightweightParticipants:(id)arg3 sentBytes:(unsigned long long)arg4 receivedBytes:(unsigned long long)arg5 offlineRequest:(bool)arg6 streamInfoRequest:(bool)arg7 status:(unsigned int)arg8;
