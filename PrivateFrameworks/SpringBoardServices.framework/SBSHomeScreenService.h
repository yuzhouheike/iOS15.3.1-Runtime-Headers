...
@property (getter=isRestrictedWidgetsIconLayoutEnabled, nonatomic) bool restrictedWidgetsIconLayoutEnabled;
...
- (bool)isRestrictedWidgetsIconLayoutEnabled;
...
- (void)setRestrictedWidgetsIconLayoutEnabled:(bool)arg1;
