...
@interface UIControl : UIView <UIContextMenuInteractionDelegate, UIContextMenuInteractionDelegate_Private, UIPointerInteractionDelegate, _UICursorInteractionDelegate, _UIVariableGestureContextMenuInteractionDelegate> {
    struct { 
