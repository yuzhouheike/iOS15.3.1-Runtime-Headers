...
@interface UITextField : UIControl <ABText, DebugHierarchyObject_Fallback, NSCoding, UIContentSizeCategoryAdjusting, UIGestureRecognizerDelegate, UIKeyInputPrivate, UIKeyboardInput, UIPopoverControllerDelegate, UITextDragSupporting, UITextDraggable, UITextDropSupporting, UITextDroppable, UITextDroppable_Private, UITextFieldContent, UITextInput, UITextInputTraits_Private, UITextPasteConfigurationSupporting, UITextPasteConfigurationSupporting_Internal, UIViewGhostedRangeSupporting, _UIFieldEditorHostingViewRequirements, _UIFloatingContentViewDelegate, _UILayoutBaselineUpdating, _UITextFieldCanvasContext, _UITextFieldClearButtonImageProviding, _UITextFieldVisualStyleSubject, _UITextItemDiscoverable, _UIViewBaselineSpacing> {
