...
@interface _UIRemoteViewController : UIViewController <UIDimmingViewDelegate, _UIEventDeferringRuleOwning, _UIRemoteViewController_ViewControllerOperatorInterface> {
...
- (bool)__shouldRemoteViewControllerFenceGeometryChange:(const struct { int x1; struct CGPoint { double x_2_1_1; double x_2_1_2; } x2; struct CGPoint { double x_3_1_1; double x_3_1_2; } x3; struct CGSize { double x_4_1_1; double x_4_1_2; } x4; id x5; id x6; id x7; id x8; }*)arg1 forAncestor:(id)arg2;
...
- (void)__viewServiceSheetPresentationControllerDidChangeContainsFirstResponder:(bool)arg1 firstResponderRequiresKeyboard:(bool)arg2 keyboardFrame:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg3 attributes:(id)arg4;
...
- (void)_setWantsEventDeferring:(bool)arg1;
...
- (bool)_wantsEventDeferringForFocusOnScreen:(id)arg1;
