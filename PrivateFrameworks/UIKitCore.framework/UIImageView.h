...
- (id)_renditionForSource:(id)arg1 size:(struct CGSize { double x1; double x2; })arg2 symbolConfiguration:(id)arg3 withCGImageProvider:(id /* block */)arg4 lazy:(bool)arg5;
