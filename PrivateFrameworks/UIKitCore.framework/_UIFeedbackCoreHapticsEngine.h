...
@property (getter=_usesFullGamut, nonatomic, readonly) bool usesFullGamut;
...
+ (bool)_supportsPlayingIndividualFeedback:(id)arg1 allowsIgnoreCapture:(bool)arg2 isFullGamutEngine:(bool)arg3;
+ (id)sharedEngine;
