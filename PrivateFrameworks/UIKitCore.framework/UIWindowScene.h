...
@interface UIWindowScene : UIScene <DebugHierarchyObject_Fallback, _UIContextBinderContextCreationPolicyHolding, _UIEventDeferringRuleOwning, _UIFallbackEnvironment, _UISceneUIWindowEventRouting, _UISceneUIWindowHosting> {
...
@property (nonatomic, readonly) NSArray *_overrideTraitCollectionForWindows;
...
@property (nonatomic, readonly) id /* block */ _windowSupportedOrientationsObserver;
...
- (id)_overrideTraitCollectionForWindows;
- (struct UIEdgeInsets { double x1; double x2; double x3; double x4; })_peripheryInsets;
- (bool)_permitContextCreationForBindingDescription:(struct { id x1; bool x2; bool x3; bool x4; bool x5; bool x6; bool x7; bool x8; bool x9; bool x10; bool x11; bool x12; bool x13; })arg1;
...
- (id /* block */)_windowSupportedOrientationsObserver;
