...
- (id)delegate;
- (long long)direction;
- (double)indicatorContentLengthForRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg1;
- (id)indicatorImage;
...
- (struct CGSize { double x1; double x2; })sizeForMaximumContentSizeFittingLength:(double)arg1;
- (id)store;
