...
@interface _UIDatePickerView : UIPickerView <UIGestureRecognizerDelegateInternal, UIPickerViewDataSource, UIPickerViewDelegate, UIPopoverPresentationControllerDelegate, _UIControlEventsGestureRecognizerDelegate, _UIDatePickerCalendarTimeLabelDelegate, _UIDatePickerViewComponent, _UIDatePickerWheelsTimeLabelDelegate, _UIPassthroughScrollInteractionDelegate> {
