...
@interface UISheetPresentationController : UIPresentationController <UIDimmingViewDelegate, UIDragInteractionDelegate, UIDropShadowViewDelegate, _UISheetInteractionDelegate, _UISheetLayoutInfoDelegate> {
