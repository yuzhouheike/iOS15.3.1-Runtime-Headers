...
- (bool)_keyCommandIsCurrentlyPerformable:(id)arg1 blockedAttributes:(unsigned long long)arg2 outTarget:(out id*)arg3 validation:(id)arg4;
- (id)_keyCommands;
...
- (long long)_physicalButtonTypeForKeyboardEvent:(id)arg1 isTextual:(bool*)arg2;
