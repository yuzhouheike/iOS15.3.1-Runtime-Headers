...
@property (getter=_useChromelessSectionHeaderFooterPinningBehavior, nonatomic, readonly) bool useChromelessSectionHeaderFooterPinningBehavior;
...
- (void)_selectRowAtIndexPath:(id)arg1 animated:(bool)arg2 scrollPosition:(long long)arg3 notifyDelegate:(bool)arg4 isCellMultiSelect:(bool)arg5 deselectPrevious:(bool)arg6;
...
- (bool)_useChromelessSectionHeaderFooterPinningBehavior;
