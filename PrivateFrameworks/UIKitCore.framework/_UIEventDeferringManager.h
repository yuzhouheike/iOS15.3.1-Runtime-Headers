...
@interface _UIEventDeferringManager : NSObject <BSDebugDescriptionProviding, _UIEventDeferringEnvironmentTargetProviding, _UIEventDeferringRuleOwning, _UISceneComponentProviding> {
