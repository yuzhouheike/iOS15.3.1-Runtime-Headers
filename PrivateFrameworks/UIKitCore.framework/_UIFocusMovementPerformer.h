...
- (void).cxx_destruct;
- (id)__findFocusCandidateInContainer:(id)arg1 forRequest:(id)arg2 minimumSearchArea:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg3 isLoadingScrollableContainer:(bool)arg4;
