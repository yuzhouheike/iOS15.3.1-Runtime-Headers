...
@property (setter=_setAuthenticationMessage:, nonatomic, retain) BKSHIDEventAuthenticationMessage *_authenticationMessage;
...
- (unsigned long long)_senderID;
- (void)_setAuthenticationMessage:(id)arg1;
