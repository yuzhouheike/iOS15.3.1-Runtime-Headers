...
@property (setter=_setMetrics:, nonatomic, retain) _UILabelMetrics *_metrics;
@property (nonatomic, readonly) _UILabelScaledMetrics *_scaledMetrics;
...
- (void)_ensureMetricsInRect:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1 forDrawing:(bool)arg2;
