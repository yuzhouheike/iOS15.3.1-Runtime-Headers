...
@interface UIKeyboardImpl : UIView <TIKeyboardInputManagerToImplProtocol, UIKBRTIPartnerDelegate, UIKeyboardCandidateControllerDelegate, UIKeyboardCandidateListDelegate, UIKeyboardImplStateProtocol, UIKeyboardLayoutSizeDelegate, UIPopoverPresentationControllerDelegate, UITextInputDelegatePrivate, UITextInputSuggestionDelegate, _UIIVCResponseDelegateImpl, _UIKeyboardTextSelectionGestureControllerDelegate> {
...
@property (nonatomic, readonly) bool automaticMinimizationEnabled;
...
- (void)assertTextForRemoteDocument:(id)arg1 withSelectionRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg2 updatingSelection:(bool)arg3;
...
- (void)performKeyboardOutput:(id)arg1 checkingDelegate:(bool)arg2 forwardToRemoteInputSource:(bool)arg3;
...
- (void)updateInputDelegateForRemoteDocumentStateChange:(id)arg1 selectedTextRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg2 forceSync:(bool)arg3;
