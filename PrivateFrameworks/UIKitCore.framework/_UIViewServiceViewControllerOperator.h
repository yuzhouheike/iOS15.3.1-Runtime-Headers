...
@interface _UIViewServiceViewControllerOperator : UIViewController <UIAdaptivePresentationControllerDelegate, _UIFocusMovementActionForwarding, _UIHostedTextServiceSessionDelegate, _UIViewServiceDeputy, _UIViewServiceDeputyRotationSource, _UIViewServiceDummyPopoverControllerDelegate, _UIViewServiceViewControllerOperator_RemoteViewControllerInterface> {
    ...
    }  _sheetPresentationControllerKeyboardFrame;
...
- (void)__hostViewWillTransitionToSize:(struct CGSize { double x1; double x2; })arg1 withContextDescription:(id)arg2 boundingPath:(id)arg3 statusBarHeight:(double)arg4 underlapsStatusBar:(bool)arg5 fence:(id)arg6 hostPresentationTime:(unsigned long long)arg7 whenDone:(id /* block */)arg8;
