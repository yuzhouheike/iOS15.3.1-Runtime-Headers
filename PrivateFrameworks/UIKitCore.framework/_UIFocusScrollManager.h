...
- (void)_ensureFocusItemIsOnscreen:(id)arg1 inEnvironmentScrollableContainer:(id)arg2;
- (void)_scrollToFocusItemWithInfo:(id)arg1 offset:(struct CGPoint { double x1; double x2; })arg2 inEnvironmentScrollableContainer:(id)arg3;
