...
- (void)_updateSceneGeometryWithSettingObserverContext:(struct { unsigned int x1 : 1; unsigned int x2 : 1; unsigned int x3 : 1; })arg1 windowScene:(id)arg2 transitionContext:(id)arg3;
