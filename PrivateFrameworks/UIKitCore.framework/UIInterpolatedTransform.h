...
+ (id)valueWithDecomposedTransform:(struct { double x1; double x2; double x3; double x4; double x5; double x6; double x7; double x8; double x9; })arg1 rotationEpsilon:(double)arg2 scaleEpsilon:(double)arg3 translationEpsilon:(double)arg4 rotationDirection:(long long)arg5;
+ (id)zero;
