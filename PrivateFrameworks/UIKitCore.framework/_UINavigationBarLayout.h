...
- (bool)clientCanUpdateChromelessTransitionProgress;
- (bool)clientUsesManualScrollEdgeAppearanceProgressSPI;
...
- (void)setClientCanUpdateChromelessTransitionProgress:(bool)arg1;
- (void)setClientUsesManualScrollEdgeAppearanceProgressSPI:(bool)arg1;
