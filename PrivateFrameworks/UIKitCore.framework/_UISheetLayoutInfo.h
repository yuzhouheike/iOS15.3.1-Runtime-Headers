...
@interface _UISheetLayoutInfo : NSObject <_UISheetPresentationControllerDetentResolutionContext, _UIViewBoundingPathChangeObserver> {
...
@property (setter=_setLargestUndimmedDetentIdentifier:, nonatomic, retain) NSString *_largestUndimmedDetentIdentifier;
@property (setter=_setLargestUndimmedDetentIdentifierWhenEdgeAttachedInCompactHeight:, nonatomic, retain) NSString *_largestUndimmedDetentIdentifierWhenEdgeAttachedInCompactHeight;
@property (setter=_setLargestUndimmedDetentIdentifierWhenFloating:, nonatomic, retain) NSString *_largestUndimmedDetentIdentifierWhenFloating;
...
@property (nonatomic, readonly) long long _reversedIndexOfCurrentDetentForTappingGrabber;
...
@property (setter=_setSelectedDetentIdentifier:, nonatomic, retain) NSString *_selectedDetentIdentifier;
...
- (long long)_reversedIndexOfCurrentDetentForTappingGrabber;
