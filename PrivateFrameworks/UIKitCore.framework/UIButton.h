...
@interface UIButton : UIControl <ABText, DebugHierarchyObject_Fallback, NSCoding, UIAccessibilityContentSizeCategoryImageAdjusting, UIAccessibilityContentSizeCategoryImageAdjustingInternal, UIButtonControl, UIGestureRecognizerDelegate, UIMenuForcedAutomaticSelectionDelegate> {
