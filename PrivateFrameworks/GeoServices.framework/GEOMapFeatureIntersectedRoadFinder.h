...
- (void).cxx_destruct;
- (id)_findRoadsAtJunction:(id)arg1 desiredRoadDirectionality:(unsigned long long)arg2 muid:(unsigned long long)arg3 featureToIgnore:(id)arg4 handler:(id /* block */)arg5 completionHandler:(id /* block */)arg6;
