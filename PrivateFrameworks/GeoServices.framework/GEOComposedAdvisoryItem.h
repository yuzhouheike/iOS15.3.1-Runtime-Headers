...
@interface GEOComposedAdvisoryItem : NSObject <NSCopying, NSSecureCoding> {
    ...
    <GEOTransitIncident> * _transitIncident;
}
...
@property (nonatomic, readonly) <GEOTransitIncident> *transitIncident;
