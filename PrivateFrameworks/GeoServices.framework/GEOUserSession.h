...
- (struct GEOSessionID { unsigned long long x1; unsigned long long x2; })_getPersisted15MoSessionId;
- (id)_getPersisted15MoSessionIdPBData;
- (double)_getPersisted15MoSessionStartTime;
- (void)_getPersisted15MoUserSessionDataOnQueue:(id)arg1 callback:(id /* block */)arg2;
...
- (void)_mapsSyncGet15MoSessionDataWithCompletion:(id /* block */)arg1;
...
- (id)_pbDataForSessionID:(struct GEOSessionID { unsigned long long x1; unsigned long long x2; })arg1;
...
- (void)_removePersisted15MoUserSessionData:(id)arg1 onQueue:(id)arg2 callback:(id /* block */)arg3;
- (void)_removePreSync15MoData;
- (void)_resetShortSessionID;
- (void)_saveSharedSessionDataByAppId:(id)arg1;
- (struct GEOSessionID { unsigned long long x1; unsigned long long x2; })_sessionIDFromPBData:(id)arg1;
- (void)_setConfigStore15MoData:(id)arg1;
- (void)_setPersisted15MoDeviceSessionData:(id)arg1;
- (void)_setPersisted15MoSessionStartTime:(double)arg1;
- (void)_setPersisted15MoUserSessionData:(id)arg1 onQueue:(id)arg2 callback:(id /* block */)arg3;
- (void)_setPersistedLongSessionData:(id)arg1;
- (void)_setPreSync15MoData:(id)arg1;
