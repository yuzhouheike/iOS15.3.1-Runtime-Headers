...
- (struct PolylineCoordinate { unsigned int x1; float x2; })_roadPolylineCoordinateForCoordinate:(struct { double x1; double x2; double x3; })arg1 segmentCoordinateIndex:(unsigned long long)arg2;
- (id)debugDescription;
- (id)description;
- (struct PolylineCoordinate { unsigned int x1; float x2; })endRouteCoordinate;
- (id)init;
- (id)initForFailedMatchWithRoute:(id)arg1 range:(struct GEOPolylineCoordinateRange { struct PolylineCoordinate { unsigned int x_1_1_1; float x_1_1_2; } x1; struct PolylineCoordinate { unsigned int x_2_1_1; float x_2_1_2; } x2; })arg2;
