...
- (struct PolylineCoordinate { unsigned int x1; float x2; })_nearestSupportPointRouteCoordinateForRouteCoordinate:(struct PolylineCoordinate { unsigned int x1; float x2; })arg1 beforeCoordinate:(bool)arg2;
...
- (struct PolylineCoordinate { unsigned int x1; float x2; })_routeCoordinateForOffset:(double)arg1 fromRouteCoordinate:(struct PolylineCoordinate { unsigned int x1; float x2; })arg2;
- (id)_supportPointsForRange:(struct GEOPolylineCoordinateRange { struct PolylineCoordinate { unsigned int x_1_1_1; float x_1_1_2; } x1; struct PolylineCoordinate { unsigned int x_2_1_1; float x_2_1_2; } x2; })arg1 shouldEncompassRange:(bool)arg2;
...
- (id)routingPathDataWithSupportPointFromStart:(struct PolylineCoordinate { unsigned int x1; float x2; })arg1 toEnd:(struct PolylineCoordinate { unsigned int x1; float x2; })arg2 supportPointsOnly:(bool)arg3;
- (struct RoutingPathLeg { int (**x1)(); struct InternalMetadata { void *x_2_1_1; } x2; struct HasBits<1> { unsigned int x_3_1_1[1]; } x3; struct CachedSize { struct atomic<int> { struct __cxx_atomic_impl<int, std::__cxx_atomic_base_impl<int>> { _Atomic int x_1_3_1; } x_1_2_1; } x_4_1_1; } x4; struct RepeatedPtrField<maps::path_codec::geo3::RoutingPathPoint> { struct Arena {} *x_5_1_1; int x_5_1_2; int x_5_1_3; struct Rep {} *x_5_1_4; } x5; struct ArenaStringPtr { struct TaggedPtr<std::string> { void *x_1_2_1; } x_6_1_1; } x6; })routingPathFromStart:(struct PolylineCoordinate { unsigned int x1; float x2; })arg1 toEnd:(struct PolylineCoordinate { unsigned int x1; float x2; })arg2 supportPointsOnly:(bool)arg3 convertEndpointsToSupportPoints:(bool)arg4;
