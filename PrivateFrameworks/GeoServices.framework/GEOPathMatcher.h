...
- (struct RoadNetworkPath<GEOPathMatcherRoadKey> { double x1; double x2; struct vector<GEOPathMatcherRoadKey, std::allocator<GEOPathMatcherRoadKey>> { struct GEOPathMatcherRoadKey {} *x_3_1_1; struct GEOPathMatcherRoadKey {} *x_3_1_2; struct __compressed_pair<GEOPathMatcherRoadKey *, std::allocator<GEOPathMatcherRoadKey>> { struct GEOPathMatcherRoadKey {} *x_3_2_1; } x_3_1_3; } x3; })_decodePathForRoute:(id)arg1 start:(struct PolylineCoordinate { unsigned int x1; float x2; })arg2 end:(struct PolylineCoordinate { unsigned int x1; float x2; })arg3 roadNetwork:(const void*)arg4;
