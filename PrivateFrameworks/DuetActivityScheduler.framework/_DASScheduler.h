...
@interface _DASScheduler : NSObject <NSXPCListenerDelegate, _DASActivityBackgroundLaunchScheduler, _DASActivityBackgroundTasksScheduler, _DASActivityGroupScheduler, _DASActivityMetering, _DASActivitySchedulerClient, _DASActivitySchedulerIntrospecting, _DASSystemConstraintsUpdating, _OSPrewarmScheduling> {
