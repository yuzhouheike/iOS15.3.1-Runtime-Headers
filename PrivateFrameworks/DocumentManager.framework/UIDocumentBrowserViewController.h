...
@interface UIDocumentBrowserViewController : UIViewController <DOCAppearanceCustomization, DOCHostDocumentBrowserViewControllerInterface, DOCRemoteViewControllerDelegate, DOCViewServiceErrorViewControllerDelegate, NSCoding, UIPresentationControllerDelegatePrivate, _UIRemoteViewControllerContaining> {
