...
- (int)activateAndPlayMXSession:(void*)arg1;
...
- (int)checkMXSessionActiveState:(unsigned char)arg1 sessionToCheck:(void*)arg2;
- (int)checkMXSessionPlayingState:(unsigned char)arg1 sessionToCheck:(void*)arg2;
...
- (int)deactivateAndStopMXSession:(void*)arg1 replacementStatusResumable:(unsigned char)arg2;
...
- (int)setMXSessionPlayingState:(struct __CFBoolean { }*)arg1 sessionToSet:(void*)arg2;
- (void)setNotificationCallback:(int (*)arg1;
- (int)setSessionPlayingState:(struct __CFBoolean { }*)arg1 sessionToSet:(struct opaqueCMSession { }*)arg2;
