...
@interface CBALSEvent : CBHIDEvent {
    ...
    struct { 
        ...
        bool asyncMode; 
        unsigned long long xtalkEstimate[6]; 
    }  _vendorData;
}
...
@property struct { unsigned int x1; unsigned char x2; unsigned char x3; unsigned short x4; unsigned int x5; unsigned int x6; int x7; float x8; float x9; float x10[6]; float x11; short x12[6]; float x13; unsigned int x14; int x15; unsigned short x16; bool x17; unsigned long long x18[6]; } vendorData;
...
- (void)setVendorData:(struct { unsigned int x1; unsigned char x2; unsigned char x3; unsigned short x4; unsigned int x5; unsigned int x6; int x7; float x8; float x9; float x10[6]; float x11; short x12[6]; float x13; unsigned int x14; int x15; unsigned short x16; bool x17; unsigned long long x18[6]; })arg1;
- (float)strength;
- (bool)supportColor;
- (struct { unsigned int x1; unsigned char x2; unsigned char x3; unsigned short x4; unsigned int x5; unsigned int x6; int x7; float x8; float x9; float x10[6]; float x11; short x12[6]; float x13; unsigned int x14; int x15; unsigned short x16; bool x17; unsigned long long x18[6]; })vendorData;
