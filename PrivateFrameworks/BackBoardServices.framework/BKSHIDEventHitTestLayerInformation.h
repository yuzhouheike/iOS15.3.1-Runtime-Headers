...
@interface BKSHIDEventHitTestLayerInformation : NSObject <BSDescriptionStreamable, BSProtobufSerializable, NSCopying, NSMutableCopying, NSSecureCoding> {
...
@property (nonatomic, readonly) float backgroundMaximum;
@property (nonatomic, readonly) float backgroundMinimum;
