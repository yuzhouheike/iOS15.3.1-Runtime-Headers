...
- (void)_forceHostApplicationInForeground:(bool)arg1;
...
- (void)setRate:(float)arg1 withVolumeRampDuration:(struct { long long x1; int x2; unsigned int x3; long long x4; })arg2 playImmediately:(bool)arg3 rateChangeReason:(int)arg4 affectsCoordinatedPlayback:(bool)arg5;
