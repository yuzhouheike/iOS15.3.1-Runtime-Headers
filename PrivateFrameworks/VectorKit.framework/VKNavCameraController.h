...
- (bool)_canZoomIn;
- (bool)_canZoomOut;
- (struct Coordinate3D<Radians, double> { struct Unit<RadianUnitDescription, double> { double x_1_1_1; } x1; struct Unit<RadianUnitDescription, double> { double x_2_1_1; } x2; struct Unit<MeterUnitDescription, double> { double x_3_1_1; } x3; })_coordinateForGeoLocation:(struct { double x1; double x2; double x3; })arg1;
