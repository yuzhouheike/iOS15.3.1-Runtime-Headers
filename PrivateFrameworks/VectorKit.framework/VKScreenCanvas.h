...
@property (nonatomic) /* Warning: unhandled struct encoding: '{_retain_ptr<VKCamera *' */ struct  vkCamera; /* unknown property attribute:  geo::_equal_objc>=^^?@{_retain_objc=}{_release_objc=}} */
...
- (void)setVkCamera:(struct _retain_ptr<VKCamera *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc> { int (**x1)(); id x2; struct _retain_objc { } x3; struct _release_objc { } x4; })arg1;
- (long long)tileSize;
- (void)transferStateFromCanvas:(id)arg1;
- (void)updateCameraForFrameResize;
- (void)updateWithTimestamp:(double)arg1 withContext:(void*)arg2;
- (struct _retain_ptr<VKCamera *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc> { int (**x1)(); id x2; struct _retain_objc { } x3; struct _release_objc { } x4; })vkCamera;
- (bool)wantsTimerTick;
