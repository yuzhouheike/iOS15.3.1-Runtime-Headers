...
@interface VKDebugSettings : NSObject {
    ...
    bool  _daVinciLightingDebugTintShadowCascades;
    ...
    bool  _daVinciVarianceShadowsEnabled;
...
@property (nonatomic) struct shared_ptr<gss::StylesheetManager<gss::PropertyID>> { void *x1; struct __shared_weak_count {} *x2; } debugStyleManager;
...
- (bool)daVinciLightingDebugTintShadowCascades;
...
- (int)daVinciSSAOKernelSize;
- (bool)daVinciSSAOOcclusionOnly;
- (bool)daVinciSSAORangeCheck;
...
- (struct shared_ptr<gss::StylesheetManager<gss::PropertyID>> { void *x1; struct __shared_weak_count {} *x2; })debugStyleManager;
...
- (void)setDaVinciLightingDebugTintShadowCascades:(bool)arg1;
...
- (void)setDaVinciSSAOEnabled:(bool)arg1;
- (void)setDaVinciSSAOIntensity:(float)arg1;
- (void)setDaVinciSSAOKernelRadius:(float)arg1;
- (void)setDaVinciSSAOKernelSize:(int)arg1;
- (void)setDaVinciSSAOOcclusionOnly:(bool)arg1;
- (void)setDaVinciSSAORangeCheck:(bool)arg1;
...
- (void)setDaVinciVarianceShadowsEnabled:(bool)arg1;
...
- (void)setDebugStyleManager:(struct shared_ptr<gss::StylesheetManager<gss::PropertyID>> { void *x1; struct __shared_weak_count {} *x2; })arg1;
...
- (void)setUseNewTextureAtlas:(bool)arg1;
