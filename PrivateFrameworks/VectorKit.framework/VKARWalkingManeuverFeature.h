...
@property (nonatomic, readonly) /* Warning: unhandled struct encoding: '{Coordinate3D<Degrees' */ struct  coordinate; /* unknown property attribute:  double>=d}} */
...
- (id).cxx_construct;
- (void).cxx_destruct;
- (struct Coordinate3D<Degrees, double> { struct Unit<DegreeUnitDescription, double> { double x_1_1_1; } x1; struct Unit<DegreeUnitDescription, double> { double x_2_1_1; } x2; struct Unit<MeterUnitDescription, double> { double x_3_1_1; } x3; })coordinate;
- (id)description;
- (id)displayText;
