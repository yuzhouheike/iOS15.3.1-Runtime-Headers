...
- (bool)buildRouteLine:(id)arg1 matchToRoads:(bool)arg2 shouldGenerateSnapPath:(bool)arg3 viewUnitsPerPoint:(double)arg4 force:(bool)arg5 boundsInflation:(float)arg6 isGradientTraffic:(bool)arg7;
- (id)composedRoute;
