...
@property (nonatomic, readonly) /* Warning: unhandled struct encoding: '{Unit<MeterUnitDescription' */ struct  appliedUndulation; /* unknown property attribute:  double>=d} */
@property (nonatomic, readonly) /* Warning: unhandled struct encoding: '{Coordinate3D<Degrees' */ struct  bottomCenterCoordinate; /* unknown property attribute:  double>=d}} */
...
@property (nonatomic, readonly) /* Warning: unhandled struct encoding: '{Unit<MeterUnitDescription' */ struct  faceHeightInMeters; /* unknown property attribute:  double>=d} */
@property (nonatomic, readonly) /* Warning: unhandled struct encoding: '{Unit<MeterUnitDescription' */ struct  faceWidthInMeters; /* unknown property attribute:  double>=d} */
...
- (id).cxx_construct;
- (void).cxx_destruct;
- (struct Unit<MeterUnitDescription, double> { double x1; })appliedUndulation;
- (struct Coordinate3D<Degrees, double> { struct Unit<DegreeUnitDescription, double> { double x_1_1_1; } x1; struct Unit<DegreeUnitDescription, double> { double x_2_1_1; } x2; struct Unit<MeterUnitDescription, double> { double x_3_1_1; } x3; })bottomCenterCoordinate;
...
- (struct Unit<MeterUnitDescription, double> { double x1; })faceHeightInMeters;
- (struct Unit<MeterUnitDescription, double> { double x1; })faceWidthInMeters;
