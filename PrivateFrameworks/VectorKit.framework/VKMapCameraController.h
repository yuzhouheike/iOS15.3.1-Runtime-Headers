...
- (id)initWithMapDataAccess:(void*)arg1 animationRunner:(struct AnimationRunner { struct MapEngine {} *x1; }*)arg2 runLoopController:(struct RunLoopController { struct MapEngine {} *x1; long long x2; long long x3; }*)arg3 cameraDelegate:(id)arg4;
- (bool)isFullyPitched;
- (bool)isPitched;
- (void*)mapEngine;
- (double)maxPitch;
