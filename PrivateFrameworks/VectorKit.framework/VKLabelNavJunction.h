...
@interface VKLabelNavJunction : NSObject <VKLabelNavFeature> {
    ...
    bool  _foundRoads;
    struct GeoCodecsConnectivityJunction { unsigned int x1; unsigned int x2; struct GeoCodecsPointFeature {} *x3; } * _geoJunction;
...
@property (nonatomic, readonly) const struct GeoCodecsConnectivityJunction { unsigned int x1; unsigned int x2; struct GeoCodecsPointFeature {} *x3; }*geoJunction;
...
- (void)findRoads;
- (const struct GeoCodecsConnectivityJunction { unsigned int x1; unsigned int x2; struct GeoCodecsPointFeature {} *x3; }*)geoJunction;
- (bool)hasSharedRouteDirection;
- (id)incomingRoad;
- (id)initWithGEOJunction:(struct GeoCodecsConnectivityJunction { unsigned int x1; unsigned int x2; struct GeoCodecsPointFeature {} *x3; }*)arg1 routeOffset:(struct PolylineCoordinate { unsigned int x1; float x2; })arg2 tile:(const void*)arg3;
