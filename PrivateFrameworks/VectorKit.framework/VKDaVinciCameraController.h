...
- (struct Coordinate2D<Radians, double> { struct Unit<RadianUnitDescription, double> { double x_1_1_1; } x1; struct Unit<RadianUnitDescription, double> { double x_2_1_1; } x2; })_centerCoordinateForMapRegion:(id)arg1;
- (struct vector<geo::Coordinate2D<Radians, double>, std::allocator<geo::Coordinate2D<Radians, double>>> { void *x1; void *x2; struct __compressed_pair<geo::Coordinate2D<Radians, double> *, std::allocator<geo::Coordinate2D<Radians, double>>> { void *x_3_1_1; } x3; })_getVisibleArea;
...
- (struct Coordinate2D<Radians, double> { struct Unit<RadianUnitDescription, double> { double x_1_1_1; } x1; struct Unit<RadianUnitDescription, double> { double x_2_1_1; } x2; })centerCoordinateRad;
...
- (double)earthRadiusAt:(struct Unit<RadianUnitDescription, double> { double x1; })arg1;
- (void)enter3DMode;
- (void)exit3DMode;
- (double)geocAngleBetween:(struct Coordinate2D<Radians, double> { struct Unit<RadianUnitDescription, double> { double x_1_1_1; } x1; struct Unit<RadianUnitDescription, double> { double x_2_1_1; } x2; })arg1 andCoordinate:(struct Coordinate2D<Radians, double> { struct Unit<RadianUnitDescription, double> { double x_1_1_1; } x1; struct Unit<RadianUnitDescription, double> { double x_2_1_1; } x2; })arg2;
- (struct Unit<RadianUnitDescription, double> { double x1; })greatCircleMidPointLatitude:(struct Unit<RadianUnitDescription, double> { double x1; })arg1 fromLongitude:(struct Unit<RadianUnitDescription, double> { double x1; })arg2 toLongitude:(struct Unit<RadianUnitDescription, double> { double x1; })arg3;
- (double)heading;
- (float)idealPitchForNormalizedZoomLevel:(float)arg1;
- (id)initWithMapDataAccess:(void*)arg1 animationRunner:(struct AnimationRunner { struct MapEngine {} *x1; }*)arg2 runLoopController:(struct RunLoopController { struct MapEngine {} *x1; long long x2; long long x3; }*)arg3 cameraDelegate:(id)arg4 mapEngine:(void*)arg5;
- (bool)isFullyPitched;
- (bool)isPitched;
- (id)mapRegion;
...
- (void)moveTo:(struct Coordinate2D<Radians, double> { struct Unit<RadianUnitDescription, double> { double x_1_1_1; } x1; struct Unit<RadianUnitDescription, double> { double x_2_1_1; } x2; })arg1 height:(double)arg2 useHeight:(bool)arg3 zoom:(double)arg4 rotation:(double)arg5 tilt:(double)arg6 duration:(double)arg7 timingCurve:(id /* block */)arg8 completion:(id /* block */)arg9;
- (void)moveTo:(struct Coordinate2D<Radians, double> { struct Unit<RadianUnitDescription, double> { double x_1_1_1; } x1; struct Unit<RadianUnitDescription, double> { double x_2_1_1; } x2; })arg1 zoom:(double)arg2 rotation:(double)arg3 tilt:(double)arg4 duration:(double)arg5 timingCurve:(id /* block */)arg6 completion:(id /* block */)arg7;
- (void)moveToZoomOutZoomInTransition:(struct Coordinate2D<Radians, double> { struct Unit<RadianUnitDescription, double> { double x_1_1_1; } x1; struct Unit<RadianUnitDescription, double> { double x_2_1_1; } x2; })arg1 height:(double)arg2 useHeight:(bool)arg3 zoom:(double)arg4 rotation:(double)arg5 tilt:(double)arg6 duration:(double)arg7 timingCurve:(id /* block */)arg8 completion:(id /* block */)arg9;
...
- (bool)usesVKCamera;
- (struct Unit<RadianUnitDescription, double> { double x1; })widestLatitudeForMapRegion:(id)arg1;
