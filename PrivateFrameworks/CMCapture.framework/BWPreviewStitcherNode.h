...
- (void)_updateShiftCorrectionsAsyncFromComputedShift:(struct CGPoint { double x1; double x2; })arg1 byRegisteringWide:(struct opaqueCMSampleBuffer { }*)arg2 tele:(struct opaqueCMSampleBuffer { }*)arg3 macroTransitionType:(int)arg4;
...
- (id)initWithCameraInfoByPortType:(id)arg1 sensorBinningFactor:(struct { int x1; int x2; })arg2 inputBuffersHaveHorizontalOverscanOnly:(bool)arg3 registrationType:(int)arg4;
...
- (void)rampToAdditionalZoomFactor:(double)arg1 momentMovieRecordingEnabled:(bool)arg2;
