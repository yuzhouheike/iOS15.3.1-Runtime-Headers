...
- (bool)_attachPointCloudsToSampleBufferOrReportMissing:(struct opaqueCMSampleBuffer { }*)arg1 pointCloudsAreMissing:(bool*)arg2;
- (id)_bufferArrayToString:(id)arg1;
- (void)_cleanupPointCloudBufferQueue;
- (bool)_mergePointClouds:(id)arg1 intoDataBuffer:(struct __CVBuffer { }*)arg2;
