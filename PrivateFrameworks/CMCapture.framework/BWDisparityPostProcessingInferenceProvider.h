...
- (int)executionTarget;
- (id)extractable;
- (id)initWithDisparityInputRequirement:(id)arg1 displacementInputRequirement:(id)arg2 previousFilteredInputRequirement:(id)arg3 outputRequirement:(id)arg4 portType:(id)arg5 resourceProvider:(id)arg6 configuration:(id)arg7;
