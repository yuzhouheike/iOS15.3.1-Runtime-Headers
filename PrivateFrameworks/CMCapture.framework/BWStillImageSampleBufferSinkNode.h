...
- (id)_coreAnalyticsPayloadWithSampleBuffer:(struct opaqueCMSampleBuffer { }*)arg1 stillImageSettings:(id)arg2;
...
- (void)_reportCoreAnalyticsForSampleBuffer:(struct opaqueCMSampleBuffer { }*)arg1 stillImageSettings:(id)arg2;
