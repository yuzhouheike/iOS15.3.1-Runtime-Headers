...
- (struct CGPoint { double x1; double x2; })_shiftCorrectionForLeftStrip:(bool)arg1 byRegisteringWide:(struct opaqueCMSampleBuffer { }*)arg2 tele:(struct opaqueCMSampleBuffer { }*)arg3 centerBias:(bool)arg4 widerToNarrowerCameraScale:(double)arg5 isMacroScene:(bool)arg6 err:(int*)arg7;
