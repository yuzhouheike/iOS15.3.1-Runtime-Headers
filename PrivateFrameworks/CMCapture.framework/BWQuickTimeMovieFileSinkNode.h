...
- (void)_collectVideoSTFAnalyticsFromSbuf:(struct opaqueCMSampleBuffer { }*)arg1;
...
- (void)_preprocessingForFirstAuxiliaryBuffer:(struct opaqueCMSampleBuffer { }*)arg1 forInputIndex:(unsigned long long)arg2;
...
- (int)_setTrackMatrixProperty:(struct opaqueCMSampleBuffer { }*)arg1 forInputIndex:(unsigned long long)arg2 fileSettings:(id)arg3 metadata:(id)arg4;
...
- (id)_validateTaggedMediaCharacteristicsForInputIndexes:(id)arg1;
