...
- (int)_executeOnSampleBuffer:(void *)arg1 usingStorage:(void *)arg2 meanPixel:(void *)arg3 withExecutionTime:(void *)arg4 completionHandler:(void *)arg5; // needs 5 arg types, found 4: struct opaqueCMSampleBuffer { }*, id, struct { long long x1; int x2; unsigned int x3; long long x4; }, id /* block */
...
- (int)executionTarget;
- (id)extractable;
- (id)initWithInputRequirement:(id)arg1 orderBufferRequirement:(id)arg2 descriptor:(id)arg3 resourceProvider:(id)arg4 meanPixelCalculator:(id)arg5 operation:(long long)arg6;
