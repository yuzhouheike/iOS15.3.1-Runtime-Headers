...
@property (getter=isSemanticStylePersonSegmentationEnabled, nonatomic) bool semanticStylePersonSegmentationEnabled;
...
- (int)_adjustRectanglesFromFiltersAndRegionArray:(id)arg1 withSampleBuffer:(struct opaqueCMSampleBuffer { }*)arg2;
- (void)_applyQueuedSemanticStyle:(struct opaqueCMSampleBuffer { }*)arg1;
- (void)_buildAndChangeToFiltersWithAnimation:(long long)arg1;
- (void)_changeToFilters:(id)arg1 animation:(long long)arg2;
- (float)_cubeStrengthForOffset:(float)arg1;
- (bool)_hasOverCaptureRegionsWithSampleBuffer:(struct opaqueCMSampleBuffer { }*)arg1;
- (void)_rebuildSemanticStyleFiltersWithSceneType:(int)arg1;
- (bool)_shouldRenderSemanticStyle;
- (void)_updateSemanticStyleFiltersAndRegionArrayWithSampleBuffer:(struct opaqueCMSampleBuffer { }*)arg1;
...
- (id)filters;
- (id)initWithCaptureDevice:(id)arg1 maxLossyCompressionLevel:(int)arg2 semanticStyleRenderingEnabled:(bool)arg3 cinematicVideoEnabled:(bool)arg4;
...
- (void)setSemanticStylePersonSegmentationEnabled:(bool)arg1;
