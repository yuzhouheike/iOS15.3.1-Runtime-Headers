...
@property (nonatomic, readonly) struct OpaqueFigSampleBufferProcessor { }*_autofocusProcessor;
@property (nonatomic, readonly) NSObject<OS_dispatch_queue> *_stillImageDispatchQueue;
...
@property (nonatomic, readonly) bool dualStreamStillImageCaptureEnabled;
...
@property (readonly) struct { struct { float x_1_1_1; float x_1_1_2; } x1[3]; struct { float x_2_1_1; float x_2_1_2; } x2[3]; struct { float x_3_1_1; float x_3_1_2; } x3[3]; bool x4; struct { unsigned int x_5_1_1; struct { float x_2_2_1; float x_2_2_2; } x_5_1_2[3]; float x_5_1_3[3]; float x_5_1_4[3]; float x_5_1_5[7]; float x_5_1_6[7][12]; int x_5_1_7; int x_5_1_8; struct { float x_9_2_1; float x_9_2_2; } x_5_1_9; struct { float x_10_2_1; float x_10_2_2; } x_5_1_10[3]; float x_5_1_11[3]; float x_5_1_12[3]; float x_5_1_13[3]; bool x_5_1_14; float x_5_1_15; float x_5_1_16; } x5; } sphereShiftState;
...
- (bool)hasFlash;
- (id)initWithCaptureDevice:(id)arg1 attributes:(id)arg2 synchronizedStreamsAttributes:(id)arg3 multiCamEnabled:(bool)arg4 applicationID:(id)arg5 clientAuditToken:(struct { unsigned int x1[8]; })arg6 tccIdentity:(id)arg7 error:(int*)arg8;
...
- (void)setCaptureDeviceType:(int)arg1;
...
- (int)setContinuousAutoFocusRect:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1 restrictToRect:(bool)arg2;
...
- (int)setFocusModeAutoWithRect:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1 restrictToRect:(bool)arg2 continuous:(bool)arg3 smooth:(bool)arg4 rangeRestrictionNear:(float)arg5 rangeRestrictionFar:(float)arg6;
...
- (id)unifiedBracketingStillImageCaptureSettingsWithID:(long long)arg1 captureRequestIdentifier:(id)arg2 frameStatisticsByPortType:(id)arg3 flashMode:(int)arg4 digitalFlashMode:(int)arg5 autoRedEyeReductionEnabled:(bool)arg6 hdrMode:(int)arg7 qualityPrioritization:(int)arg8 speedOverQualityCaptureEnabled:(bool)arg9 waitForTimeMachineToFill:(bool)arg10 burstQualityCaptureEnabled:(bool)arg11 deliverOriginalImage:(bool)arg12 bravoConstituentImageDeliveryDeviceTypes:(id)arg13 deliverDepthData:(bool)arg14 autoDeferredProcessingEnabled:(bool)arg15 includePreBracketedEV0ForProcessing:(bool)arg16 clientBracketSettings:(id)arg17 userInitiatedRequestPTS:(struct { long long x1; int x2; unsigned int x3; long long x4; })arg18 rawOutputFormat:(unsigned int)arg19 processingSupportProvider:(id)arg20;
