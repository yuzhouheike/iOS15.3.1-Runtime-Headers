...
- (struct opaqueCMSampleBuffer { }*)_newOutputSampleBufferWithPixelBuffer:(struct __CVBuffer { }*)arg1 inputSampleBuffer:(struct opaqueCMSampleBuffer { }*)arg2 appliedPrimaryCaptureRect:(bool)arg3;
