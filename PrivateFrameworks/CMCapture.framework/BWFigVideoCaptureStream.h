...
@property (nonatomic, readonly) bool activePrefersStillImageShiftedToMatchSpatialOverCapturePreview;
...
- (id)initWithCaptureStream:(id)arg1 attributes:(id)arg2 sensorIDDictionary:(id)arg3 synchronizedStreamsGroup:(id)arg4 applicationID:(id)arg5 clientAuditToken:(struct { unsigned int x1[8]; })arg6 tccIdentity:(id)arg7 error:(int*)arg8;
- (bool)isStationary;
