...
- (id)_initWithFigCaptureMovieFileRecordingSettings:(id)arg1 stillImageCaptureTime:(struct { long long x1; int x2; unsigned int x3; long long x4; })arg2 stillImageCaptureHostTime:(struct { long long x1; int x2; unsigned int x3; long long x4; })arg3 stillImageCaptureAbsoluteStartTime:(double)arg4 stillImageRequestSettings:(id)arg5 stillImageCaptureSettings:(id)arg6 originalPhotoRecording:(bool)arg7 semanticStyle:(id)arg8;
