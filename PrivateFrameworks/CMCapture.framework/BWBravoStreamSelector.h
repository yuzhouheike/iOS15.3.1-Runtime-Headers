...
- (id)recommendMasterStreamUsingCurrentMasterStream:(id)arg1 frameStatisticsByPortType:(id)arg2 zoomFactor:(float)arg3 digitalFlashMode:(int)arg4 detectedObjects:(id)arg5;
