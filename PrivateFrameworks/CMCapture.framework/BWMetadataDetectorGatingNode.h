...
- (struct __CVBuffer { }*)_createOutputPixelBufferFromSbuf:(struct opaqueCMSampleBuffer { }*)arg1 appliedPrimaryCaptureRect:(bool*)arg2;
...
- (void)_updateNodeOutputPassthroughMode:(int)arg1;
