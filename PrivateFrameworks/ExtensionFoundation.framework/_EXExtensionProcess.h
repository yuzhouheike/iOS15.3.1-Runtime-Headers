...
- (id)initWithExtension:(id)arg1 auditToken:(struct { unsigned int x1[8]; })arg2;
- (id)initWithExtension:(id)arg1 auditToken:(struct { unsigned int x1[8]; })arg2 processIdentity:(id)arg3 sandboxExtensions:(id)arg4;
