...
@property (nonatomic, retain) MRAVOutputDevice *unclusteredLocalOutputDevice;
@property (nonatomic, retain) NSArray *unclusteredOutputDevices;
...
- (void)setUnclusteredLocalOutputDevice:(id)arg1;
- (void)setUnclusteredOutputDevices:(id)arg1;
- (unsigned int)targetAudioSessionID;
- (id)unclusteredLocalOutputDevice;
- (id)unclusteredOutputDevices;
