...
@property (nonatomic, retain) AFHeadphonesAnnouncementRoute *currentlyRoutedHeadphonesRoute;
...
- (id)currentlyRoutedHeadphonesRoute;
...
- (void)setCurrentlyRoutedHeadphonesRoute:(id)arg1;
