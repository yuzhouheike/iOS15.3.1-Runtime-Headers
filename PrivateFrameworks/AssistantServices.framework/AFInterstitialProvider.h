...
- (id)initWithStyle:(long long)arg1 recordRoute:(id)arg2 isVoiceTrigger:(bool)arg3 isDucking:(bool)arg4 isTwoShot:(bool)arg5 speechEndHostTime:(unsigned long long)arg6 context:(id)arg7 instanceContext:(id)arg8 delegate:(id)arg9;
- (void)invalidate;
