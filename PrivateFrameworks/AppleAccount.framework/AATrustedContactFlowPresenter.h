...
@interface AATrustedContactFlowPresenter : NSObject <AATrustedContactPresenterHostProtocol, NSXPCListenerDelegate, SBSRemoteAlertHandleObserver, TrustedContactFlowPresenterProtocol> {
...
- (void)trustedContactRequestFinishedWithError:(id)arg1 completion:(id /* block */)arg2;
