...
@interface CMPhotoProcessMonitor : NSObject {
    ...
    NSObject<OS_dispatch_queue> * _backgroundNotificationCallbackQueue;
...
@property (nonatomic, retain) NSObject<OS_dispatch_queue> *backgroundNotificationCallbackQueue;
...
- (id)backgroundNotificationCallbackQueue;
- (void)dealloc;
- (id)domainAttribute;
- (bool)gotRBSConnectionError;
- (id)heldAssertions;
- (id)initForForegroundApp:(bool)arg1;
- (id)latestAssertion;
...
- (void)setBackgroundNotificationCallbackQueue:(id)arg1;
