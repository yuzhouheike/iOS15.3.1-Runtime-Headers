...
- (id)description;
- (id)initWithAttributes:(struct { unsigned char x1[16]; unsigned char x2[16]; unsigned char x3; unsigned char x4; unsigned char x5; unsigned char x6; unsigned char x7; unsigned char x8; unsigned char x9; unsigned char x10; unsigned short x11; unsigned short x12; unsigned int x13; unsigned int x14; unsigned short x15; bool x16; BOOL x17[16]; unsigned char x18; }*)arg1 maxBitrate:(unsigned int)arg2 relayServerProvider:(long long)arg3 relaySessionToken:(id)arg4 relaySessionKey:(id)arg5;
