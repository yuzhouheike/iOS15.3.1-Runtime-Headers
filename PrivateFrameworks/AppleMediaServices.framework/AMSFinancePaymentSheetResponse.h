...
+ (id)_createRequestFromDictionary:(id)arg1 confirmationOnly:(bool)arg2 delegateAuthenticationRequired:(bool)arg3 biometricSignatureRequired:(bool)arg4 authenticateResponse:(id)arg5 taskInfo:(id)arg6;
