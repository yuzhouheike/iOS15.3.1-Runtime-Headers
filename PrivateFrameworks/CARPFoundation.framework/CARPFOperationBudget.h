...
@property (nonatomic, readonly) struct _CARPFRate { unsigned long long x1; double x2; } rate;
...
- (id)init;
- (id)initWithLimit:(unsigned long long)arg1 rate:(struct _CARPFRate { unsigned long long x1; double x2; })arg2;
- (bool)isEmpty;
- (bool)isFull;
- (unsigned long long)limit;
- (struct _CARPFRate { unsigned long long x1; double x2; })rate;
- (void)reset;
