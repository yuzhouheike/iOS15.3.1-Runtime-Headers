...
- (struct Object { int (**x1)(); struct Atomic { struct { int x_1_2_1; } x_2_1_1; } x2; unsigned int x3; }*)CA_copyRenderValueWithColorspace:(struct CGColorSpace { }*)arg1;
...
- (id)carpf_registerObserverForKeyPath:(id)arg1 options:(unsigned long long)arg2 handler:(id /* block */)arg3;
