...
@interface __NSCFURLSessionDelegateWrapper : NSObject {
    ...
    unsigned int  accept__sessionCompanionAvailabilityChanged;
    unsigned int  accept__sessionNeedConnectedSocketToHost;
    ...
    unsigned int  checked__sessionCompanionAvailabilityChanged;
    unsigned int  checked__sessionNeedConnectedSocketToHost;
