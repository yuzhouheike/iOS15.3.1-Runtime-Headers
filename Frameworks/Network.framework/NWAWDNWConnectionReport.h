...
@interface NWAWDNWConnectionReport : PBCodable <NSCopying> {
    ...
    int  _connectedInterfaceSubtype;
    ...
    unsigned long long  _estimatedDownloadThroughput;
    unsigned long long  _estimatedUploadThroughput;
    int  _failureReason;
    ...
    struct { 
        ...
        unsigned int estimatedDownloadThroughput : 1; 
        unsigned int estimatedUploadThroughput : 1; 
        ...
        unsigned int connectedInterfaceSubtype : 1; 
        ...
        unsigned int quicSpeculativeAttempt : 1; 
...
@property (nonatomic, retain) NSMutableArray *proxyHops;
...
- (int)StringAsConnectedInterfaceSubtype:(id)arg1;
...
- (int)StringAsPrivacyStance:(id)arg1;
...
- (id)connectedInterfaceSubtypeAsString:(int)arg1;
...
- (bool)preferFallback;
- (int)privacyStance;
- (id)privacyStanceAsString:(int)arg1;
- (id)processName;
...
- (id)proxyHops;
- (id)proxyHopsAtIndex:(unsigned long long)arg1;
...
- (void)setConnectedInterfaceSubtype:(int)arg1;
...
- (void)setEstimatedDownloadThroughput:(unsigned long long)arg1;
- (void)setEstimatedUploadThroughput:(unsigned long long)arg1;
...
- (void)setHasConnectedInterfaceSubtype:(bool)arg1;
...
- (void)setHasEstimatedDownloadThroughput:(bool)arg1;
- (void)setHasEstimatedUploadThroughput:(bool)arg1;
...
- (void)setHasPreferFallback:(bool)arg1;
- (void)setHasPrivacyStance:(bool)arg1;
...
- (void)setHasQuicSpeculativeAttempt:(bool)arg1;
...
- (void)setPreferFallback:(bool)arg1;
- (void)setPrivacyStance:(int)arg1;
...
- (void)setQuicSpeculativeAttempt:(bool)arg1;
