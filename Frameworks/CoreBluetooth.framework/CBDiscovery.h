...
@interface CBDiscovery : NSObject <CBActivatable, CBDeviceReporting, CBErrorReporting, CBInterruptable, CBLabelable, CBStateReporting, CBSystemOverridable, CBXPCReceivable, CUXPCCodable> {
