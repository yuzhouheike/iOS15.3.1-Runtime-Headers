...
- (const void*)createAssertionForConnectionType:(int)arg1 allocator:(const struct __CFAllocator { }*)arg2 error:(id*)arg3 onReAssertError:(id /* block */)arg4;
...
- (bool)hasCellularAndValidContext:(id)arg1 error:(id*)arg2;
