...
+ (id)encodedPeopleFetcherForForFetchRequest:(id)arg1 addressBook:(void*)arg2 managedConfiguration:(id)arg3 addressBookCompletionHandler:(id /* block */)arg4 cursorCompletionHandler:(id /* block */)arg5 environment:(id)arg6;
+ (void)initialize;
