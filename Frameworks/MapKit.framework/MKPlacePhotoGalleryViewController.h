...
@interface MKPlacePhotoGalleryViewController : UIViewController <MKActivityObserving, MUPlacePhotoGalleryAttributionViewDelegate, UIGestureRecognizerDelegate, UIScrollViewDelegate> {
...
- (id)additionalView;
- (id)attributionLogoUsingDarkAppearance:(bool)arg1 forPhoto:(id)arg2;
- (id)attributionView;
...
- (bool)isPhotoProvidedByApple:(id)arg1;
- (id)keyCommands;
