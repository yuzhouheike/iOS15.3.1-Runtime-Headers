...
@interface MKTransitDeparturesDataSource : NSObject <MKTransitDeparturesCellDelegate, MKTransitDeparturesDataProviderDelegate, MKTransitSystemFilterViewDelegate, UITableViewDataSource, UITableViewDelegate, _MKTransitConnectionCellDelegate> {
