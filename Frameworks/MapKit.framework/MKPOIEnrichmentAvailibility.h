...
+ (bool)shouldShowAddPhotoButtonsOnPhotoGalleryForMapItem:(id)arg1 photoAttribution:(id)arg2;
+ (bool)shouldShowAddPhotoButtonsOnSlideshowGalleryForMapItem:(id)arg1 photoAttribution:(id)arg2 options:(unsigned long long)arg3;
