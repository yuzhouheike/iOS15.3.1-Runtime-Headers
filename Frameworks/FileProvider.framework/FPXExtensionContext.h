...
- (id)_createItemBasedOnTemplate:(id)arg1 fields:(unsigned long long)arg2 contents:(id)arg3 options:(unsigned long long)arg4 request:(id)arg5 bounce:(bool)arg6 bounceCollidingItem:(bool)arg7 bounceNumber:(id)arg8 completionHandler:(id /* block */)arg9;
...
- (id)fetchContentsForItemWithID:(id)arg1 version:(id)arg2 request:(id)arg3 completionHandler:(id /* block */)arg4;
- (id)fetchContentsForItemWithID:(id)arg1 version:(id)arg2 usingExistingContentsAtURL:(id)arg3 existingVersion:(id)arg4 request:(id)arg5 completionHandler:(id /* block */)arg6;
