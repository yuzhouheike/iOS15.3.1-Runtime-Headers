...
+ (id)chooseChildSAProposalFromLocalProposals:(id)arg1 remoteProposals:(id)arg2 preferRemoteProposals:(bool)arg3 checkDHGroup:(bool)arg4;
...
- (id)copyForRekey;
- (id)copyFromRemote:(id)arg1 checkDHGroup:(bool)arg2 preferRemoteProposal:(bool)arg3;
