...
+ (id)chooseSAProposalFromLocalProposals:(id)arg1 remoteProposals:(id)arg2 preferRemoteProposals:(bool)arg3;
...
- (id)copyFromRemote:(id)arg1 preferRemoteProposal:(bool)arg2;
