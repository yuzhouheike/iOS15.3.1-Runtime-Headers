...
@interface CNContactListViewController : UITableViewController <CNAvatarCardControllerDelegate, CNAvatarViewControllerDelegate, CNContactDataSourceDelegate, CNContactListBannerViewDelegate, CNContactSuggestionsViewControllerDelegate, CNContactViewControllerDelegate, CNUIObjectViewControllerDelegate, CNVCardImportControllerDelegate, CNVCardImportControllerPresentationDelegate, TPKContentControllerDelegate, UIGestureRecognizerDelegate, UISearchBarDelegate, UISearchControllerDelegate, UISearchResultsUpdating, UITableViewDragDestinationDelegate, UITableViewDragSourceDelegate> {
    ...
    struct CGPoint { 
        double x; 
        double y; 
    }  _noContactsTableViewOffsetStash;
...
@property (nonatomic) struct CGPoint { double x1; double x2; } noContactsTableViewOffsetStash;
...
- (struct CGPoint { double x1; double x2; })noContactsTableViewOffsetStash;
- (id)noContactsView;
...
- (void)reloadContacts;
- (void)scrollToRowAtIndexPath:(id)arg1 animated:(bool)arg2 scrollPosition:(long long)arg3;
...
- (void)setNoContactsTableViewOffsetStash:(struct CGPoint { double x1; double x2; })arg1;
