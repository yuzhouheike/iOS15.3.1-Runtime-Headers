...
- (id).cxx_construct;
- (void).cxx_destruct;
- (void)addCompiledOutput:(id)arg1 cachedCompiledOutput:(id)arg2 importedSymbols:(id)arg3 importedLibraries:(id)arg4 hashKey:(const struct { unsigned char x1[32]; }*)arg5 functionCache:(const struct MultiLevelPipelineCache { bool x1; id x2; id x3; struct MTLCompilerCache {} *x4; struct MTLCompilerCache {} *x5; struct MTLCompilerCache {} *x6; bool x7; bool x8; }*)arg6;
- (void)addCompiledOutput:(id)arg1 importedSymbols:(id)arg2 importedLibraries:(id)arg3 hashKey:(const struct { unsigned char x1[32]; }*)arg4 functionCache:(const struct MultiLevelPipelineCache { bool x1; id x2; id x3; struct MTLCompilerCache {} *x4; struct MTLCompilerCache {} *x5; struct MTLCompilerCache {} *x6; bool x7; bool x8; }*)arg5;
...
- (void)cacheCompilerData:(void*)arg1 cachedData:(void*)arg2 hashMap:(void*)arg3 libraryData:(struct MTLLibraryData { int (**x1)(); struct { unsigned char x_2_1_1[32]; } x2; _Atomic int x3; id x4; id x5; }*)arg4 functionCache:(const struct MultiLevelPipelineCache { bool x1; id x2; id x3; struct MTLCompilerCache {} *x4; struct MTLCompilerCache {} *x5; struct MTLCompilerCache {} *x6; bool x7; bool x8; }*)arg5;
- (void)compileDynamicLibrary:(id)arg1 computePipelineDescriptor:(id)arg2 completionHandler:(id /* block */)arg3;
...
- (id)compilerQueue;
- (struct VariantEntry { char *x1; unsigned long long x2; unsigned long long x3; unsigned long long x4; id x5; id x6; unsigned long long x7; id x8; }*)computeVariantEntryWithDescriptor:(id)arg1 options:(unsigned long long)arg2 serializedComputeDataDescriptor:(id)arg3 asyncCompile:(bool)arg4 pipelineCache:(id)arg5 destinationBinaryArchive:(id)arg6 computeProgram:(struct MTLProgramObject {}**)arg7 kernelDriverCompileTimeData:(id*)arg8 compileTimeStatistics:(id)arg9;
- (bool)copyShaderCacheToPath:(id)arg1;
- (id)createVertexStageAndLinkPipelineWithFragment:(void*)arg1 fragmentVariant:(id)arg2 vertexFunction:(id)arg3 serializedVertexDescriptor:(id)arg4 descriptor:(id)arg5 destinationArchive:(id)arg6 options:(unsigned long long)arg7 reflection:(id*)arg8 compileStatistics:(id)arg9 fragmentCompileTimeData:(id)arg10 error:(id*)arg11 completionHandler:(id /* block */)arg12;
- (void)dealloc;
- (void*)getProgramObject:(id)arg1 destinationArchive:(id)arg2 sourceBinaryArchives:(id)arg3 variantKey:(const struct VariantKey { void *x1; void *x2; unsigned long long x3; unsigned long long x4; id x5; void *x6; unsigned long long x7; }*)arg4 requiredBinaryKeys:(const void*)arg5 failOnMiss:(bool)arg6;
- (void*)getProgramObjectForFunction:(id)arg1 variantKey:(const struct VariantKey { void *x1; void *x2; unsigned long long x3; unsigned long long x4; id x5; void *x6; unsigned long long x7; }*)arg2 requiredBinaryKeys:(const void*)arg3 sourceBinaryArchives:(id)arg4;
...
- (id)pipelineStateWithVariant:(struct VariantEntry { char *x1; unsigned long long x2; unsigned long long x3; unsigned long long x4; id x5; id x6; unsigned long long x7; id x8; }*)arg1 descriptor:(id)arg2 options:(unsigned long long)arg3 computeProgram:(void*)arg4 kernelDriverCompileTimeData:(id)arg5 serializedComputeDataDescriptor:(id)arg6 compileTimeStatistics:(id)arg7 reflection:(id*)arg8 error:(id*)arg9 completionHandler:(id /* block */)arg10;
- (id)pluginPath;
...
- (struct vector<std::pair<CompilerOutputType, MTLBinaryKey *>, std::allocator<std::pair<CompilerOutputType, MTLBinaryKey *>>> { void *x1; void *x2; struct __compressed_pair<std::pair<CompilerOutputType, MTLBinaryKey *> *, std::allocator<std::pair<CompilerOutputType, MTLBinaryKey *>>> { void *x_3_1_1; } x3; })requiredKeysForFunction:(id)arg1 variantKey:(const struct VariantKey { void *x1; void *x2; unsigned long long x3; unsigned long long x4; id x5; void *x6; unsigned long long x7; }*)arg2 frameworkData:(id)arg3 compilerOptions:(int)arg4;
- (void)statelessBackendCompileRequestInternal:(struct MTLCompilerFunctionRequest { int (**x1)(); int x2; id x3; id x4; id x5; unsigned int x6; unsigned int x7; unsigned int x8; id x9; id x10; unsigned long long x11; id x12; id x13; id x14; id x15; int x16; bool x17; unsigned int x18; }*)arg1 sync:(bool)arg2 compilerHash:(const struct { unsigned char x1[32]; }*)arg3 reflectionOnly:(bool)arg4 completionHandler:(id /* block */)arg5;
