...
- (void).cxx_destruct;
- (id)connection;
- (void)createCustodianRecoveryKey:(id)arg1 contextID:(id)arg2 uuid:(id)arg3 reply:(id /* block */)arg4;
- (void)createInheritanceKey:(id)arg1 contextID:(id)arg2 uuid:(id)arg3 reply:(id /* block */)arg4;
...
- (void)fetchAccountSettings:(id)arg1 contextID:(id)arg2 reply:(id /* block */)arg3;
- (void)fetchAccountWideSettings:(id)arg1 contextID:(id)arg2 reply:(id /* block */)arg3;
...
- (void)fetchTrustedSecureElementIdentities:(id)arg1 contextID:(id)arg2 reply:(id /* block */)arg3;
- (void)fetchUserControllableViewsSyncStatus:(id)arg1 contextID:(id)arg2 reply:(id /* block */)arg3;
- (void)generateInheritanceKey:(id)arg1 contextID:(id)arg2 uuid:(id)arg3 reply:(id /* block */)arg4;
...
- (void)joinWithCustodianRecoveryKey:(id)arg1 contextID:(id)arg2 custodianRecoveryKey:(id)arg3 reply:(id /* block */)arg4;
- (void)joinWithInheritanceKey:(id)arg1 contextID:(id)arg2 inheritanceKey:(id)arg3 reply:(id /* block */)arg4;
...
- (void)preflightJoinWithCustodianRecoveryKey:(id)arg1 contextID:(id)arg2 custodianRecoveryKey:(id)arg3 reply:(id /* block */)arg4;
- (void)preflightJoinWithInheritanceKey:(id)arg1 contextID:(id)arg2 inheritanceKey:(id)arg3 reply:(id /* block */)arg4;
- (void)refetchCKKSPolicy:(id)arg1 contextID:(id)arg2 reply:(id /* block */)arg3;
- (void)removeCustodianRecoveryKey:(id)arg1 contextID:(id)arg2 uuid:(id)arg3 reply:(id /* block */)arg4;
- (void)removeFriendsInClique:(id)arg1 context:(id)arg2 peerIDs:(id)arg3 reply:(id /* block */)arg4;
- (void)removeInheritanceKey:(id)arg1 contextID:(id)arg2 uuid:(id)arg3 reply:(id /* block */)arg4;
- (void)removeLocalSecureElementIdentityPeerID:(id)arg1 contextID:(id)arg2 secureElementIdentityPeerID:(id)arg3 reply:(id /* block */)arg4;
...
- (void)setLocalSecureElementIdentity:(id)arg1 contextID:(id)arg2 secureElementIdentity:(id)arg3 reply:(id /* block */)arg4;
...
- (void)storeInheritanceKey:(id)arg1 contextID:(id)arg2 ik:(id)arg3 reply:(id /* block */)arg4;
- (bool)sync;
- (bool)synchronous;
- (void)tapToRadar:(id)arg1 description:(id)arg2 radar:(id)arg3 reply:(id /* block */)arg4;
- (void)tlkRecoverabilityForEscrowRecordData:(id)arg1 contextID:(id)arg2 recordData:(id)arg3 reply:(id /* block */)arg4;
- (void)waitForOctagonUpgrade:(id)arg1 context:(id)arg2 reply:(id /* block */)arg3;
- (void)waitForPriorityViewKeychainDataRecovery:(id)arg1 contextID:(id)arg2 reply:(id /* block */)arg3;
