...
- (id /* block */)provideItemForKernelRequestWithInfo:(id)arg1 atURL:(id)arg2 forProcess:(int)arg3 withOptions:(unsigned long long)arg4 completionHandler:(id /* block */)arg5;
